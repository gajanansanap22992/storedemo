...
public class Test {
	...
	public static void main(String[] args) throws IOException {
		...
		System.out.println("col "+lastCol);
		System.out.println("");
		ArrayList<Employee> al=new ArrayList<Employee>();
	    for(int i=1;i<=lastRow;i++)
		{
			XSSFRow currentRow=sheet.getRow(i);
			String emai=currentRow.getCell(0).getStringCellValue().toString();
			...
			al.add(new Employee(email.toLowerCase(), password, fname, lname, gender, dob, companyname, taxexempt, newsletter, customerrole, manager, active, admincomment));
		...
		{
			Employee e=i.next();
			System.out.println(e.email+" "+e.dateofbirth);
		}
	}
